# Generated by Powerlevel10k configuration wizard on 2023-05-26 at 21:55 -03.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 12407.
# Wizard options: powerline, ascii, lean_8colors, 12h time, 1 line, sparse, concise,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_FIRST_SEGMENT_END_SYMBOL='%B%{%}'
